            ...
            <div class="col-lg-8">
                <div class="blog-post-item">
                    <div class="blog-post-thumb">
                        <a href="index.php?action=details_blog"><img src="assets/img/blog/blog_thumb01.jpg" alt=""></a>
                    </div>
                    <div class="blog-post-content">
                        <span class="date"><i class="far fa-clock"></i> 10 Mar 2021</span>
                        <h2 class="title"><a href="index.php?action=details_blog">Your Free Movie Streaming Purposes</a></h2>
