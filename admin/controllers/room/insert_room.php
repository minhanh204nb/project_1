<div class="page-wrapper">
    <div class="content container-fluid">
        <form action="?action=insert_room" method="post">
            <label for="">NAME ROOM</label>
            <div> <input type="text" name="name_room" required placeholder="name room"></div>
            <div> <input type="text" name="trangthai" required placeholder="trang thai"></div>
            <br>
                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2">
                        ...
                        <div class="page-header">
                            <div class="row">
                                <div class="col-sm-12">
                                    <h3 class="page-title">Add Room</h3>
                                </div>
                            </div>
                        </div>
                        <form action="?action=insert_room" method="post" class="card">
                            <div class="card-body">
                                ...
                                <input type="submit" name="btn" class="btn btn-primary me-2" value="INSERT">
