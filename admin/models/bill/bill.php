...
function update_bill($id_bill, $price_tickets, $price_combo, $name_movie, $cinema, $room, $seats, $show_day, $showtime, $total_price, $note, $action)
{
    $sql = "UPDATE bill SET price_tickets = '$price_tickets', price_combo = '$price_combo', name_movie='$name_movie',cinema='$cinema',room='$room',seats='$seats',show_day='$show_day',showtime='$showtime',total_price='$total_price',note='$note',action='$action' WHERE id_bill = '$id_bill'";
    pdo_execute($sql);
}
